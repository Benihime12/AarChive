...
public class EleventhGuidedExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton btnBackGE11 = findViewById(R.id.btnBackGE11);

        btnBackGE11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EleventhGuidedExercise.this, MainActivity.class);
